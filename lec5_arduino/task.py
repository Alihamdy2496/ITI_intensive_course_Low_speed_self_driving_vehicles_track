...
# i won't use this line since i don't have an arduino , i'll just fill this fill with the given data 
...
if filesize == 0:
    ...
    # Otherwise your option is to use the physical connection as identification, 
    # which is this directory name “1-1:1.0” It is unique for the physical connection, 
    # and will as you already mentioned change if you plug the device to another port.

...
#ifndef MYMSGSRV__SRV__DETAIL__CUSTOM_SRV__FUNCTIONS_H_
#define MYMSGSRV__SRV__DETAIL__CUSTOM_SRV__FUNCTIONS_H_
 ...
 * calls
 * mymsgsrv__srv__CustomSrv_Request__init().
...
/**
 * It calls
 * mymsgsrv__srv__CustomSrv_Request__fini()
 ...
 * mymsgsrv__srv__CustomSrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mymsgsrv__srv__CustomSrv_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mymsgsrv__srv__CustomSrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mymsgsrv
...
/**
 * It calls
 * mymsgsrv__srv__CustomSrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mymsgsrv
...
/**
 * It allocates the memory for the array and calls
 * mymsgsrv__srv__CustomSrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mymsgsrv
...
/**
 * It calls
 * mymsgsrv__srv__CustomSrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MYMSGSRV__SRV__DETAIL__CUSTOM_SRV__FUNCTIONS_H_

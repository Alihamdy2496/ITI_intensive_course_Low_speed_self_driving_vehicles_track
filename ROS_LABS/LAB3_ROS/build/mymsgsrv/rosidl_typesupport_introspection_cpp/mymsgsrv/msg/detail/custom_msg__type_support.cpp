...
{
  new (message_memory) mymsgsrv::msg::CustomMsg(_init);
}

void CustomMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mymsgsrv::msg::CustomMsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CustomMsg_message_member_array[2] = {
  {
    ...
    offsetof(mymsgsrv::msg::CustomMsg, text),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mymsgsrv::msg::CustomMsg, value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CustomMsg_message_members = {
  "mymsgsrv::msg",  // message namespace
  "CustomMsg",  // message name
  2,  // number of fields
  sizeof(mymsgsrv::msg::CustomMsg),
...
{
  return &::mymsgsrv::msg::rosidl_typesupport_introspection_cpp::CustomMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mymsgsrv, msg, CustomMsg)() {
  return &::mymsgsrv::msg::rosidl_typesupport_introspection_cpp::CustomMsg_message_type_support_handle;
}

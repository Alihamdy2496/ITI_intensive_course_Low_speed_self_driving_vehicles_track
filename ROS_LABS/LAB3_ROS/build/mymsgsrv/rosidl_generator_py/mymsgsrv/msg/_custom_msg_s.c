...
bool mymsgsrv__msg__custom_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mymsgsrv.msg._custom_msg.CustomMsg", full_classname_dest, 34) == 0);
  }
  mymsgsrv__msg__CustomMsg * ros_message = _ros_message;
  {  // text
...
PyObject * mymsgsrv__msg__custom_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mymsgsrv.msg._custom_msg");

...
static const _CustomSrv_Request_type_support_symbol_names_t _CustomSrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mymsgsrv, srv, CustomSrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mymsgsrv, srv, CustomSrv_Request)),
  }
};
...
{
  return &::mymsgsrv::srv::rosidl_typesupport_cpp::CustomSrv_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mymsgsrv, srv, CustomSrv_Request)() {
  return get_message_type_support_handle<mymsgsrv::srv::CustomSrv_Request>();
}
...
static const _CustomSrv_Response_type_support_symbol_names_t _CustomSrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mymsgsrv, srv, CustomSrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mymsgsrv, srv, CustomSrv_Response)),
  }
};
...
{
  return &::mymsgsrv::srv::rosidl_typesupport_cpp::CustomSrv_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mymsgsrv, srv, CustomSrv_Response)() {
  return get_message_type_support_handle<mymsgsrv::srv::CustomSrv_Response>();
}
...
static const _CustomSrv_type_support_symbol_names_t _CustomSrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mymsgsrv, srv, CustomSrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mymsgsrv, srv, CustomSrv)),
  }
};
...
{
  return &::mymsgsrv::srv::rosidl_typesupport_cpp::CustomSrv_service_type_support_handle;
}

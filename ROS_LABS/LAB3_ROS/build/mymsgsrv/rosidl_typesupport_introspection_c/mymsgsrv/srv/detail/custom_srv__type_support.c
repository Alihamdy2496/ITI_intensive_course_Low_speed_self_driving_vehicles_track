...
#include <stddef.h>
#include "mymsgsrv/srv/detail/custom_srv__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  mymsgsrv__srv__CustomSrv_Request__init(message_memory);
}

void CustomSrv_Request__rosidl_typesupport_introspection_c__CustomSrv_Request_fini_function(void * message_memory)
{
  mymsgsrv__srv__CustomSrv_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember CustomSrv_Request__rosidl_typesupport_introspection_c__CustomSrv_Request_message_member_array[1] = {
  {
    "reqq",  // name
    ...
    offsetof(mymsgsrv__srv__CustomSrv_Request, reqq),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers CustomSrv_Request__rosidl_typesupport_introspection_c__CustomSrv_Request_message_members = {
  "mymsgsrv__srv",  // message namespace
  "CustomSrv_Request",  // message name
  1,  // number of fields
  sizeof(mymsgsrv__srv__CustomSrv_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mymsgsrv, srv, CustomSrv_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember CustomSrv_Response__rosidl_typesupport_introspection_c__CustomSrv_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mymsgsrv__srv__CustomSrv_Response, rspp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers CustomSrv_Response__rosidl_typesupport_introspection_c__CustomSrv_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(mymsgsrv__srv__CustomSrv_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_mymsgsrv
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mymsgsrv, srv, CustomSrv_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers mymsgsrv__srv__detail__custom_srv__rosidl_typesupport_introspection_c__CustomSrv_service_members = {
  "mymsgsrv__srv",  // service namespace
  "CustomSrv",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // mymsgsrv__srv__detail__custom_srv__rosidl_typesupport_introspection_c__CustomSrv_Request_message_type_support_handle,
  NULL  // response message
  // mymsgsrv__srv__detail__custom_srv__rosidl_typesupport_introspection_c__CustomSrv_Response_message_type_support_handle
};

static rosidl_service_type_support_t mymsgsrv__srv__detail__custom_srv__rosidl_typesupport_introspection_c__CustomSrv_service_type_support_handle = {
  0,
  &mymsgsrv__srv__detail__custom_srv__rosidl_typesupport_introspection_c__CustomSrv_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mymsgsrv, srv, CustomSrv)() {
  if (!mymsgsrv__srv__detail__custom_srv__rosidl_typesupport_introspection_c__CustomSrv_service_type_support_handle.typesupport_identifier) {
    mymsgsrv__srv__detail__custom_srv__rosidl_typesupport_introspection_c__CustomSrv_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)mymsgsrv__srv__detail__custom_srv__rosidl_typesupport_introspection_c__CustomSrv_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mymsgsrv, srv, CustomSrv_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mymsgsrv, srv, CustomSrv_Response)()->data;
  }

  return &mymsgsrv__srv__detail__custom_srv__rosidl_typesupport_introspection_c__CustomSrv_service_type_support_handle;
}

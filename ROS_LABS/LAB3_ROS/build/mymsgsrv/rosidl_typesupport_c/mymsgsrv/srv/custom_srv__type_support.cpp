...
#include "mymsgsrv/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _CustomSrv_Request_type_support_symbol_names_t _CustomSrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mymsgsrv, srv, CustomSrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mymsgsrv, srv, CustomSrv_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_mymsgsrv
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mymsgsrv, srv, CustomSrv_Request)() {
  return &::mymsgsrv::srv::rosidl_typesupport_c::CustomSrv_Request_message_type_support_handle;
}
...
static const _CustomSrv_Response_type_support_symbol_names_t _CustomSrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mymsgsrv, srv, CustomSrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mymsgsrv, srv, CustomSrv_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_mymsgsrv
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mymsgsrv, srv, CustomSrv_Response)() {
  return &::mymsgsrv::srv::rosidl_typesupport_c::CustomSrv_Response_message_type_support_handle;
}
...
static const _CustomSrv_type_support_symbol_names_t _CustomSrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mymsgsrv, srv, CustomSrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mymsgsrv, srv, CustomSrv)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mymsgsrv, srv, CustomSrv)() {
  return &::mymsgsrv::srv::rosidl_typesupport_c::CustomSrv_service_type_support_handle;
}

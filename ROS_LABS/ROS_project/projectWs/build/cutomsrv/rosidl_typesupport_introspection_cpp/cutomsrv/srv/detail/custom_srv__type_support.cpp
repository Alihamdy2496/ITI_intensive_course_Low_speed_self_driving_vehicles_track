...
{
  new (message_memory) cutomsrv::srv::CustomSrv_Request(_init);
}

void CustomSrv_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cutomsrv::srv::CustomSrv_Request *>(message_memory);
  typed_message->~CustomSrv_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember CustomSrv_Request_message_member_array[2] = {
  {
    "x",  // name
    ...
    offsetof(cutomsrv::srv::CustomSrv_Request, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cutomsrv::srv::CustomSrv_Request, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CustomSrv_Request_message_members = {
  "cutomsrv::srv",  // message namespace
  "CustomSrv_Request",  // message name
  2,  // number of fields
  sizeof(cutomsrv::srv::CustomSrv_Request),
...
{
  return &::cutomsrv::srv::rosidl_typesupport_introspection_cpp::CustomSrv_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cutomsrv, srv, CustomSrv_Request)() {
  return &::cutomsrv::srv::rosidl_typesupport_introspection_cpp::CustomSrv_Request_message_type_support_handle;
}
...
void CustomSrv_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) cutomsrv::srv::CustomSrv_Response(_init);
}

void CustomSrv_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cutomsrv::srv::CustomSrv_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CustomSrv_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cutomsrv::srv::CustomSrv_Response, ack),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CustomSrv_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(cutomsrv::srv::CustomSrv_Response),
...
{
  return &::cutomsrv::srv::rosidl_typesupport_introspection_cpp::CustomSrv_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cutomsrv, srv, CustomSrv_Response)() {
  return &::cutomsrv::srv::rosidl_typesupport_introspection_cpp::CustomSrv_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers CustomSrv_service_members = {
  "cutomsrv::srv",  // service namespace
  "CustomSrv",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<cutomsrv::srv::CustomSrv>()
...
get_service_type_support_handle<cutomsrv::srv::CustomSrv>()
{
  ...
  auto service_type_support =
    &::cutomsrv::srv::rosidl_typesupport_introspection_cpp::CustomSrv_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cutomsrv, srv, CustomSrv)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<cutomsrv::srv::CustomSrv>();
}
